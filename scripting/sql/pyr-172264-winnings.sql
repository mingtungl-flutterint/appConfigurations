...
with jackpots as (
	...
	where je.jackpotid=23012
	  ...
	  and je.refpstime between timestamp('2021-05-21-09.38.40') - 1 minute
	  and timestamp('2021-05-21-09.40.00') + 1 minute
	  and je.jpxctime between timestamp('2021-05-21-09.38.40')
	  and timestamp('2021-05-21-09.40.00') - 1 microsecond
...
, win as (
	select * from jackpots where eventtype in (3,13)

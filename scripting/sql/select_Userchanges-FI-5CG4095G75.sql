...
where USERINTID in (${uiids}$)
--and when BETWEEN '2024-01-11 00:00:00' AND cast('2024-01-12 00:00:00' as TIMESTAMP) - 1 microsecond
--and adminintid in (select userintid from db2admin.users where userid='HostAnooraT')
 --and updatedfield in (1,2,3,4,5,6,9,25,26,27)
 --and updatetype in (7,43,65,173)
